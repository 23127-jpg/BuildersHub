    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <div style={{ width: '100%', maxWidth: '400px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '12px', padding: '2rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h1 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', fontWeight: 600, marginTop: '1rem' }}>Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input type="password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} placeholder="••••••••" style={{ ...inputStyle, borderColor: errors.password ? '#f87171' : 'var(--border)' }} />
